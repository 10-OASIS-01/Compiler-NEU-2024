...
本项目为东北大学《编译原理》课程设计的参考实现，供学习与研究使用。  

**若您是东北大学在读学生，并计划基于本项目进行相关开发，请务必事先联系项目作者（邮箱：yibin.leon.liu@outlook.com）以获取授权与进一步开发的指导。**

请注意，**任何未经许可而直接使用本项目代码完成课程作业的行为，均可能被视为学术不端，由此引发的后果（如作业雷同、抄袭判定等）由使用者自行承担，项目作者不对此承担任何责任。**
...
若您希望在此课设代码上进一步开发，欢迎提交 issue 或 pull request。贡献方式：
